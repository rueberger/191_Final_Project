...
From this point, we can arrive upon the $\mathbb{Z}_{p,q}$ quandle colorings of any $T(n,2)$ torus knot by finding all $q$ satisfying the equivalence relation above $\forall x,y \in \mathbb{Z}_p$
