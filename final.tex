...
We first restrict ourselves to $(r,n)$-torus where $r = 2$. Furthermore we only concern $Z_p$ when $p$ is prime to ensure that every element of $Z_p$ is a unit and every so every element has an inverse.
