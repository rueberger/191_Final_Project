...
Because we are restricting ourselves to the quandle colorings of knots and we are restricting $n$ to be prime this means that $n$ must be odd. We can then simplify the congruences to the following:
